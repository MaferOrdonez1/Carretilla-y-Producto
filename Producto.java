...
/**
 * Esta clase define objetos de tipo Producto de un comercio cada producto se
 * identifica con un nombre y precio
 *
 */
public class Producto {
    ...
    public void ListaProducto(String producto, double cantidad)
    {
